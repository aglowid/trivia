...
class UserGamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_game" do
    assert_difference('UserGame.count') do
      post user_games_url, params: { user_game: { game_id: @user_game.game_id, user_id: @user_game.user_id } }
    end
  ...
  test "should update user_game" do
    patch user_game_url(@user_game), params: { user_game: { game_id: @user_game.game_id, user_id: @user_game.user_id } }
